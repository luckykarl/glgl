    ...
    public GuideView(Activity activity, List<SinglePage> guideContent, boolean drawDot, Bitmap dotDefault, Bitmap dotSelected) {
        ...
        if (guideContent != null && guideContent.size() > 1 && drawDot) {
            ...
            for (int i = 0; i < guideContent.size(); i++) {
                SingleElement e = new SingleElement(mDotXStart + mDotXPlus * i, mDotY, mDotXStart + mDotXPlus * i, mDotY, 1.0f, 1.0f, dotDefault);
                mDotList.add(e);
            }
            mSelectedDot = new SingleElement(mDotXStart + mDotXPlus * mPosition, mDotY, mDotXStart + mDotXPlus * mPosition, mDotY, 1.0f, 1.0f, dotSelected);
        }
    }
