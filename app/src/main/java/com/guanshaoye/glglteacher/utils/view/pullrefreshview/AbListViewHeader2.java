 ...
 */
public class AbListViewHeader2 extends LinearLayout {
	 ...
	 */
	public AbListViewHeader2(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public AbListViewHeader2(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		//从包里获取的箭头图片
		arrowImageView.setImageResource(R.drawable.arrow_refresh);
	...
	public void setState(int state) {
		...
		switch(state){
			case STATE_NORMAL:
				...
				tipsTextview.setText(R.string.xlistview_header_hint_normal);
				
				if(lastRefreshTime==null){
					lastRefreshTime = AbDateUtil.getCurrentDate(AbDateUtil.dateFormatHMS);
					headerTimeView.setText("上次更新时间: "+ lastRefreshTime);
				}else{
					headerTimeView.setText("上次更新时间： "+ lastRefreshTime);
				}
