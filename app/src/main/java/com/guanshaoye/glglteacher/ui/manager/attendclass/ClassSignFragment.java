...
public class ClassSignFragment extends BaseFragment implements OnItemClickListener {
    ...
    private void initView() {
        ...
        adapter = new AttendClassAdapter(getSelfActivity(),true);
    ...
    private void getSingList() {
        ManagerApi.getTAttendClassList(CurrentUser.getUser().getTid(), 1, page, new RequestBack() {
            @Override
