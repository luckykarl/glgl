...
public class TrainSignFragment extends BaseFragment implements OnTrainItemClickListener {
    ...
    private void initView() {
        ...
        adapter = new TrainAdapter(getSelfActivity(),true);
    ...
    private void getTrainSignList() {
        ManagerApi.getTrainSignList(CurrentUser.getUser().getTid(), 1, page, new RequestBack() {
            @Override
