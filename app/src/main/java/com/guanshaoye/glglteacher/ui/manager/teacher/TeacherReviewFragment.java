...
public class TeacherReviewFragment extends BaseFragment implements OnCommentClickListener {
    ...
    private void initView() {
        ...
        adapter = new TeacherReviewAdapter(getSelfActivity(), true);
    ...
    private void getCommentList() {
        ManagerApi.getCommentnList(CurrentUser.getUser().getTid(), 1, page, new RequestBack() {
            @Override
