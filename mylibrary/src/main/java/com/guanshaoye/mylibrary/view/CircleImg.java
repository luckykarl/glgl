package com.guanshaoye.mylibrary.view;
...
public class CircleImg extends ImageView {
	...
	public CircleImg(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.CircleImg, defStyle, 0);

		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.CircleImg_border_width, DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.CircleImg_border_color,
